...
const PayAmountInput = React.forwardRef<HTMLInputElement, PayAmountInputProps>(
  ({ className, currency, setCurrency, ...props }, ref) => {
...
PayAmountInput.displayName = 'PayAmountInput'
export { PayAmountInput }
