...
export const PayCardBase: React.FC<PropsWithChildren<PayCardBaseProps>> = ({
  ...
  return (
    <div
      className={twMerge(
        'flex cursor-pointer items-center overflow-hidden rounded-[10px] border border-gray-200 p-3 pr-5 shadow-card transition-all hover:border-gray-300 hover:shadow-md',
        isSelected &&
