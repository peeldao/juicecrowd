...
export function ManageHeader() {
  ...
  return (
    <header className="sticky right-0 top-0 z-10 mb-8 border-b border-solid border-b-gray-100 bg-white dark:border-b-slate-500 dark:bg-slate-900">
      <div className="mx-auto flex max-w-5xl items-center justify-between p-5">
        ...
        <Link href={`/p/${projectId}`} className="text-gray-700">
