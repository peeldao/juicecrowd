  ...
  return (
    <footer className={className}>
      <div className="flex flex-col justify-between gap-8 bg-gray-50 px-10 py-5 md:flex-row md:items-center md:px-20 md:py-10">
        ...
        <div className="flex w-full max-w-xl flex-col justify-between gap-x-3 gap-y-4 text-sm md:flex-row">
          ...
          <Link href="/create" className="font-medium text-gray-600 underline">
            Launch a campaign
          </Link>
        </div>
      </div>
